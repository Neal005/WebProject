      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="hidden text-xxs text-gray-400 sm:block m-0">In-Browser WebML & Hugging Face Engine</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="hidden items-center gap-1.5 rounded-full border border-indigo-500/10 bg-indigo-500/5 px-3 py-1 text-xs text-indigo-300 lg:flex">
            ...
            <span>Image: Transformers.js (Local Cache)</span>
          </div>
